...
If you are building `mcpd` from source or contributing, you will also need [**Go**](https://go.dev/doc/install) (`v1.27.1+` required).
...
- [**Go**](https://go.dev/doc/install) (v1.27.1+ required)
